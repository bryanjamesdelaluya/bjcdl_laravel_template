        ...
        <div class="container">
            <div class="footer__wrapper--row row">
                <div class="col-lg-9 footer__item">
                    © 2020 Custom Template Web Design by <a href="https://bjcdl.github.io/" target="_blank">BJCDL</a>  |  <a href="{{url('terms-of-use')}}">Terms of Use</a>  |  <a href="{{url('privacy-policy')}}">Privacy policy</a>
                </div>
