...
<body>
<img src="{{ asset('public/images/placeholders/backgrounds/bg.jpg') }}" alt="Login Full Background" class="full-bg {{--animation-pulseSlow--}}">
        ...
        <div class="col-md-12">
                ...
                <div id="login-container" class="animation-fadeIn">
                        ...
                        <div class="block push-bit">
                            ...
                            <div class="copyright">
                                <a href="https://bjcdl.github.io/" target="_blank">Developed by: BJCDL</a>
                            </div>
                        </div>
                    </div>
                    <div id="modal-terms" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
